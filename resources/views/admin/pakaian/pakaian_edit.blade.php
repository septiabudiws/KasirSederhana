        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                <form action="{{ route('pakaian.update', $pakaians->token) }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" name="nama" type="text" placeholder="Masukkan Nama Produk ..."
                        id="example-text-input" value="{{ $pakaians->nama_pakaian }}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <select class="form-select" name="kategori">
                        ...
                        @foreach ($kategori as $item)
                          <option value="{{ $item->id }}" {{ $item->id == $pakaians->kategori_id ? 'selected' : '' }}>{{ $item->nama_kategori }}</option>
                        @endforeach
                      </select>
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="text" placeholder="Masukkan Nama Brand ..."
                        id="example-text-input2" name="brand" value="{{ $pakaians->brand }}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="number" placeholder="contoh: 150000" id="example-text-input3"
                        name="harga" value="{{ $pakaians->harga }}">
                    </div>
                  </div>
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      @foreach ($size as $get)
                        <input class="form-check-input" type="checkbox" id="formCheck{{ $get->id }}" name="size[]"
                          value="{{ $get->id }}" @if(in_array($get->id, $selectedSize)) checked @endif>
                    ...
                    <div class="col-md-10">
                      @foreach ($color as $key)
                        <input class="form-check-input" type="checkbox" id="formColor{{ $key->id }}" name="color[]"
                          value="{{ $key->id }}"  @if(in_array($key->id, $selectedColor)) checked @endif>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <input class="form-control" type="number" placeholder="30" id="example-text-input4"
                        name="stok" value="{{ $pakaians->stok_barang }}">
                    </div>
                  </div>
                  <div class="row mb-3">
                      ...
                      <div class="form-control h-100 text-center position-relative p-4 p-lg-5">
                        <label for="file-upload" class="file-upload mb-0">
                          <span class="d-inline-block wh-110 bg-body-bg rounded-10 position-relative ">
                            <img id="blah" src="{{ asset('gambar_produk/' . $pakaians->gambar) }}" alt="your image" />
                          </span>
                        </label>
                  ...
                  <div class="mb-3 row">
                    ...
                    <div class="col-md-10">
                      <textarea name="deskripsi" id="editor" class="form-control">{{ old('deskripsi') ?? $pakaians->deskripsi }}</textarea>
                    </div>
                  </div>
